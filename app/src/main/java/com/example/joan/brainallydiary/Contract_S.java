...
public class Contract_S {
    ...
    //Info per la Taula Pendents de Compartir
    public static String NOM_TAULA_Infants_Pendents_Compartir = "Infants_Pendents_Compartir";
    public static String Camp_Usuari_Receptor_id = "Usuari_Receptor_id";
    public static String Camp_Usuari_Principal_id = "Usuari_Principal_id";
    //Camp Infant ID
    //Camp Nom_I
    //Camp Relació
    ...
    //Camp Infant ID
    public static String Camp_Trastorn_Principal = "Trastorn Principal";
    ...
    public static final String TAULA_Usuaris_Info_Basica = "CREATE TABLE "+NOM_TAULA_Usuari_Info_Basica+" (" +
            ""+Camp_Usuari_id+" TEXT,"+Camp_Nom_U+" TEXT,"+Camp_Cognoms_U+" TEXT,"+Camp_Data_Neixament+" TEXT,"+Camp_Genere+" TEXT,"+Camp_Pais+" TEXT,"+Camp_Codi_Postal+" TEXT)";

    public static final String TAULA_Relacio_Usuari_Infants = "CREATE TABLE "+NOM_TAULA_Relacio_Usuari_Infant+" (" +
            ""+Camp_Usuari_id+" TEXT,"+Camp_Infant_ID+" TEXT,"+Camp_Relacio+" TEXT)";

    public static final String TAULA_Infants_Pendents_Compartir = "CREATE TABLE "+NOM_TAULA_Infants_Pendents_Compartir+" (" +
            ""+Camp_Usuari_Receptor_id+" TEXT,"+Camp_Usuari_Principal_id+" TEXT,"+Camp_Infant_ID+" TEXT,"+Camp_Nom_I+" TEXT,"+Camp_Relacio+" TEXT)";
